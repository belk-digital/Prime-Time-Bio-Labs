...
export interface Product {
  ...
  variants?:
    | {
        ...
        isKit?: boolean | null;
        /**
         * Optional specific images for this variant
         */
        images?:
          | {
              image: number | Media;
    ...
    | null;
  /**
   * Offer multi-kit bulk bundles of THIS product directly on the product page.
   */
  bulkBundles?:
    | {
        /**
  ...
  /**
   * Upload the Certificate of Analysis (COA) document
   */
  coaFile?: (number | null) | Document;
  /**
   * Batch number shown on the certificates page
   */
  coaBatchNumber?: string | null;
  /**
   * Purity/potency percentage
   */
  coaPurity?: number | null;
  /**
   * Date the batch was analyzed
   */
...
/**
 * The single byline used across every blog post.
 *
 * This interface was referenced by `Config`'s JSON-Schema
