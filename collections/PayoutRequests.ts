...
export const PayoutRequests: CollectionConfig = {
  ...
  // TODO: port afterChange hook (afterPayoutRequestChange) that creates an AffiliatePayouts
  // record and updates Affiliates.totalCommissionRequested when status changes.
}
